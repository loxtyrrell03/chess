(function () {
      ...
      <section class="panel">
        ...
        <div class="body">
          ...
          <section class="settings">
            ...
            <div class="hint">Auto network uses the current material imbalance. Auto contempt probes at neutral, then adds up to +250 practical bias when the side to move is worse.</div>
          </section>
  ...
  function updateDashboardAnalysis(analysis) {
    ...
    const networkLabels = { none: "BT4", knight: "T1 knight", rook: "T1 rook", queen_for_knight: "T1 Q-for-N", queen: "LQO queen" };
